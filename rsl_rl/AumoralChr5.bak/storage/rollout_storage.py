...
from AumoralChr5.utils import split_and_pad_trajectories
...
class RolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, privileged_obs_shape, actions_shape, Hist_info_shape, image_info_shape, device='cpu'):
        self.device = device
